WITH edh_opps AS (
    ...
    SELECT
        ...
        CASE
            WHEN bsd_opp.opportunity_tags__c ILIKE '%Partner Led%'
              OR bsd_opp.opportunity_tags__c ILIKE '%Led by Partner%'
                THEN 'Yes'
            ELSE 'No'
        END                                                             AS is_partner_led,
        edh_opp.source_created_ts::DATE                                 AS opportunity_created_date,
...
acs_only_opps AS (
    ...
    SELECT
        ...
        acs_opp.created_date::DATE                                      AS opportunity_created_date,

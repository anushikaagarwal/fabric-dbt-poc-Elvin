...
acs_only_accounts AS (
    SELECT
        ...
        NULL::VARCHAR                                                   AS account_region,
        NULL::VARCHAR                                                   AS named_account_group,
        NULL::VARCHAR                                                   AS account_segment,
        ca.account_type,
        NULL::VARCHAR                                                   AS parent_account_name,
        NULL::NUMBER                                                    AS account_hierarchy_depth,
        NULL::VARCHAR                                                   AS account_hierarchy_level,
        NULL::VARCHAR                                                   AS account_category,
        NULL::VARCHAR                                                   AS industry_segment,
        NULL::BOOLEAN                                                   AS is_targeted_account,
        NULL::VARCHAR                                                   AS account_sales_rep_number,
